...
class CurrencyRateRepositoryConfigurationImplTest {

    @Mock
    private lateinit var sharedPreferences: SharedPreferences

    @InjectMocks
    private lateinit var configuration: CurrencyRateRepositoryConfigurationImpl
    ...
    fun `Should save the base currency to the shared preferences`() {
        ...
        verify(editor).putString(
            CurrencyRateRepositoryConfigurationImpl.KEY_CURRENCY,
            "EUR"
        )
        verify(editor).apply()
    }
