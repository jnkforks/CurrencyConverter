...
class CurrencyCalculatorExceptionMapperImpl :
    ...
    private fun mapHandledException(currencyCalculatorException: CurrencyCalculatorException): Int =
        when (currencyCalculatorException) {
            is CurrencyCalculatorGeneralException ->
                R.string.rates_calculator__general_error_message
            is CurrencyCalculatorParseException ->
                R.string.rates_calculator__parsing_error_message
            is CurrencyCalculatorConnectionErrorException ->
                R.string.rates_calculator__network_error_message
        }
}